...
class Element extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            [['desc_en', 'desc_uz', 'desc_ru', 'desc_tr'], 'string'],
            [['uploaded_images', 'deleted_images', 'sorted_images', 'top_element', 'fat_element_id', 'short_title_ru', 'short_title_en', 'short_title_uz', 'short_title_tr'], 'safe'],
            [['product_id', 'title_ru', 'title_uz', 'title_en', 'title_tr'], 'required'],
            [['title_ru', 'title_uz', 'title_en', 'title_tr', 'img', 'slug'], 'string', 'max' => 255],
        ];
