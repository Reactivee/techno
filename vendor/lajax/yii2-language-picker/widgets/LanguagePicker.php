...
class LanguagePicker extends \yii\base\Widget
{
    ...
    private $_SKINS = [
        self::SKIN_DROPDOWN => [
            'itemTemplate' => '<li><a class="dropdown-item" href="{link}" title="{language}"><i class="{language}"></i> {name}</a></li>',
            'activeItemTemplate' => '<a class="ibtn_outline_yellow px-3 py-3 text-decoration-none  dropdown-toggle color_black" href="" title="{language}"><i class="{language} mr-1"></i> {name}</a>',
            'parentTemplate' => '<div class="language-picker dropdown-list {size}"><div>{activeItem}<ul>{items}</ul></div></div>',
        ],
        self::SKIN_BUTTON => [
            'itemTemplate' => '<a class="dropdown-item" href="{link}" title="{language}"><i class="{language}"></i> {name}</a>',
            'activeItemTemplate' => '<a href="{link}" title="{language}" class="active dropdown-item   text-decoration-none  dropdown-toggle color_black"><i class="{language}"></i> {name}</a>',
            'parentTemplate' => '<div class="language-picker dropdown-menu  button-list {size}"><div>{items}</div></div>',
        ],
    ];
