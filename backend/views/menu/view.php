...
<div class="menus-view box box-info">
    <div class="box-header with-border">
        <h3 class="box-title"><?php echo Html::encode(Yii::t('views', 'Menu Items')) ?></h3>
    </div>
    <div class="box-body">
        <p>
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="#tab_1" data-toggle="tab">
                        <i class="fa fa-th"></i>&nbsp;<b> <?php echo Yii::t('views', 'Grid') ?></b></a>
                </li>
                <li>
                    <a href="#tab_2" data-toggle="tab">
                        <i class="fa fa-tree"></i>&nbsp;<b> <?php echo Yii::t('views', 'Tree') ?></b></a>
                </li>
            </ul>
            <div class="tab-content">
                ...
                <div class="tab-pane tree" id="tab_2">
                    ...
                    <?php echo (!empty($dataTree) && Helper::checkRoute('drag-drop')) ? FancytreeWidget::widget([
                        'options' => [
                            'source' => $dataTree,
                            'extensions' => ['dnd'],
                            'dnd' => [
