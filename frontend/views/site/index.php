            ...
            <div class="col-lg-4">
                <div class="advan-content">
                    <div class="card purple">
                        <h2 class="text-center mb-3 ">Наши
                            преимущества</h2>
                        <p class="font-weight-bold">Аккредитованная испытательная лаборатория Индивидуальный подход
                            Сертифицированная продукция Доверие партнёров Инновационные технологии Гарантия качества</p>
                        ...
                        <div class="col-lg-3">
                            <div class="contact-info">
                                <ul>
                                    <li>
                                        <div class="icon">
                                            <img src="/uploads/images/about-left-image.png" alt="email icon">
                                        </div>
                                        <a href="#">info@company.com</a>
                                    </li>
                                    <li>
                                        <div class="icon">
                                            <img src="/contact-icon-02.png" alt="phone">
                                        </div>
