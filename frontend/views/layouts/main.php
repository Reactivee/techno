...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="GET" action="site/send-request">

                <div class="modal-body">
                    <input class="form-control mb-2" type="text" name="name" placeholder="Имя">
                    <input class="form-control mb-2" type="text" name="phone" placeholder="Телефон">
                    <input class="form-control" type="text" name="text" placeholder="Сообщение">
